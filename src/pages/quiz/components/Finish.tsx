...
export default function Finish({ points, restart, goBack }: FinishProps) {
    return <>
        <div className="absolute left-0 bottom-0 top-11 h-full md:h-100 w-full backdrop-blur-sm"></div>
        <div className="absolute left-0 right-0 mx-auto p-4 md:p-14 w-4/5 sm:w-2/3 rounded-xl bg-mauve-800 shadow-md">
