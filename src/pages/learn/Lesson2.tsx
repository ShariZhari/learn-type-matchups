...
export default function Lesson2() {
  ...
  return <Learn>
    ...
    <h2 className="text-2xl mt-4">The role of resistances in dual type matchups</h2>
    ...
    <h2 className="text-2xl mt-4">The role of immunities in dual type matchups</h2>
    ...
    <h2 className="text-2xl mt-4">Extremely effective and Mostly ineffective types</h2>
    ...
    <p className="mb-3">If both types of a pokémon are weak to the same type, then the type makes <b>extremely effective</b> damage to the pokemon.</p>
